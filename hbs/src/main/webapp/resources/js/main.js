...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "resources/css/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "resources/css/" + selectedTheme + ".css");
		...
		function switchLogo(theme) {
			switch (theme) {
				case "default-theme":
					$(".navbar-brand img").attr("src", "resources/images/logo2.png");
					break;

				default:
					$(".navbar-brand img").attr("src", "resources/images/logo.png");
					break;
			};
		};
		function defaultSetting() {
			...
			$('#skin_color').attr("href", "resources/css/default-theme.css");
			$(".navbar-brand img").attr("src", "resources/images/logo.png");
